...
#define APP_DEFAULT_ADD                 0x08004000 /* The first 2 sectores (16 KB) are reserved for DFU code */
...
int main(void)
{
	...
	// 测试加密
	{
		...
		// read flash
		buf = code;
		//match_Read(0x08003E00, (uint16_t*)buf, BUF_LEN/2);
		_mtext = (uint32_t*)buf;
#else
		_mtext = (uint32_t*)0x08003E00;
#endif
		// match
		for(led=0; led<8; led++)
		{
