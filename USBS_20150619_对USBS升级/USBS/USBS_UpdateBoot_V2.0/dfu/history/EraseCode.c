...
static void _Write_Flash(uint32_t WriteAddr,uint16_t *pBuffer,uint16_t NumToWrite);
...
__attribute__ ((section ("._code"))) __attribute__((used)) void erase_match_first(void)  
{
	char code[0x10]={0};
	uint32_t addr=0;
//	uint16_t *p=NULL;
...
static __attribute__ ((section ("._code"))) __attribute__((used)) void passwd_code(void)
{
...
//static void erase_init(void)
static __attribute__ ((section ("._code"))) __attribute__((used)) void erase_init(void)
{
#if 1
	mtext _mtext;
	dprintf("erase_init\r\n");
...
// 19K
//__attribute__ ((section (".__cram"))) __attribute__((used)) int cram_entry(void)
int cram_entry(void)
{
	passwd_code();
	return 0;
